                ...
                if (error.toString().startsWith(`Error: timeout of ${TIMEOUT}ms exceeded`)) {
                    ...
                    switch (res_data.response.status) {
                        case 400: //400--后台自定义抛出异常
                            ...
                            break;
                            // case code_status.NO_REQUEST:                           //404--错误地址
                            //     //消息提示
                            //     Message({
                            //         showClose: true,
                            //         message: '访问地址不存在',
                            ...
                            //     });
                            //     break;
                            // case code_status.NO_METHOD:                           //405--type方式错误
                            //     //消息提示
                            //     Message({
                            //         showClose: true,
                            //         message: '请求type方式错误',
                            ...
                            //     });
                            //     break;
                            // case code_status.NO_JSON:                           //415--JOSN请求出错
                            //     //消息提示
                            //     Message({
                            //         showClose: true,
                            //         message: '请求json类型错误',
                            ...
                            //     });
                            //     break;
                        case code_status.BIZ_ERR: //500--后台解析错误
                            //消息提示
                            // let tip;
                            if (res_data.response.data) {
                                let tip = res_data.response.data.message;
